...
const FuzzyText = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      if (hollow) {
        // Draw hollow text with stroke and shadow for dimension
        offCtx.strokeStyle = strokeColor || color;
        ...
        // Draw additional strokes for thickness and dimension
        offCtx.shadowColor = 'transparent';
        offCtx.lineWidth = strokeWidth * 0.6;
        offCtx.strokeStyle = 'rgba(255, 255, 255, 0.4)';
        offCtx.strokeText(text, xOffset - actualLeft - 1, actualAscent - 1);
      } else {
        // Draw filled text
  ...
  }, [children, fontSize, fontWeight, fontFamily, color, strokeColor, strokeWidth, hollow, enableHover, baseIntensity, hoverIntensity]);
